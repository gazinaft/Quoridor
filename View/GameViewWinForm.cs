        ...
        public void DisplayPotentialWallsAndCorners(GameFieldState state) {
            ...
            for (int i = 0; i < state.Width; i++) {
                for (int j = 1; j < state.Height; j++) {
                    ...
                    rightWall.Height = 2 * buttonSize + wallSize;
                    rightWall.Width = wallSize;
                    rightWall.Location = new Point(ButtonGrid[i, j].Location.X - wallSize, ButtonGrid[i, j].Location.Y - buttonSize - wallSize);
            ...
            for (int i = 0; i < state.Width - 1; i++) {
                for (int j = 1; j < state.Height; j++) {
                    ...
                    higherWall.Width = 2 * buttonSize + wallSize;
                    higherWall.Height = wallSize;
        ...
        public void DisplayTheField(GameFieldState state) {
            ...
            for (int i = 0; i < state.Width; i++ ) {
                for (int j =0; j < state.Height; j++) {
                    ...
                    GamePanel.Controls.Add(ButtonGrid[i, j]);
                    ButtonGrid[i, j].Location = new Point( i * (buttonSize + wallSize), j* (buttonSize + wallSize));
                    ButtonGrid[i, j].Click += GameViewWinForm_Click;
                }
            }
